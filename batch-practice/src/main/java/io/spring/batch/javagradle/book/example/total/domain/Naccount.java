...
public class Naccount {
    ...
    private final List<Ntransaction> transactions = new ArrayList<>();

    public Naccount(long id, BigDecimal balance, Date lastStatementDate) {
        this.id = id;
    ...
    public List<Ntransaction> getTransactions() {
