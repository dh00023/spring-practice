...
import static dh0023.example.springbatchreal.jobs.mybatis.MysqlMybatisPagingConfiguration.JOB_NAME;

@Configuration
@RequiredArgsConstructor
@Import(SpringBatchConfigurer.class)
@ConditionalOnProperty(name = "spring.batch.job.names", havingValue = JOB_NAME)
public class MysqlMybatisPagingConfiguration {

    public static final String JOB_NAME = "mysqlMybatisPagingJob";
    ...
    public MyBatisPagingItemReader<Ncustomer> reader(SqlSessionFactory sqlSessionFactory) {
