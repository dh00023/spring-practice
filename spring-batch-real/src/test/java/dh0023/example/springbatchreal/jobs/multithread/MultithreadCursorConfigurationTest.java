...
@ContextConfiguration(classes = {
        ...
        , MultithreadCursorConfiguration.class
        , TestDataSourceConfig.class})
@TestPropertySource(properties = {"spring.batch.job.names=" + MultithreadCursorConfiguration.JOB_NAME, "poolSize=5", "chunkSize=1"})
class MultithreadCursorConfigurationTest {
    ...
    @Test
    public void ITEM_CURSOR_READER_병렬수행_테스트() throws Exception {
        for (int i = 1; i <= 60; i++) {
            saveNcustomer(i);
        }
        ...
        assertThat(stepExecution.getReadCount()).isEqualTo(55);
    }
